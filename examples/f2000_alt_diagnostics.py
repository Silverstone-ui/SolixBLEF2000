...
def print_status(device: F2000Alt, label: str) -> None:
    ...
    print(f"solar_power_in:       {device.solar_power_in}")
    print(f"power_in (total):     {device.power_in}")
    print(f"ac_output:            {device.ac_output}")
    print(f"ac_cable_connected:   {device.ac_cable_connected}")
    print(f"dc_output:            {device.dc_output}")
    print(f"dc1_power:            {device.dc1_power}")
    print(f"dc2_power:            {device.dc2_power}")
    print(f"usb_c1/c2/c3_power:   {device.usb_c1_power}/{device.usb_c2_power}/{device.usb_c3_power}")
    print(f"usb_a1/a2_power:      {device.usb_a1_power}/{device.usb_a2_power}")
    print(f"external/total batt%: {device.external_battery_percentage}/{device.total_battery_percentage}")
